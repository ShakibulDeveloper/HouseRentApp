                ...
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hi there,</p>
                        <p>I am writing to advise you that it appears from my records that your rent is currently overdue.</p>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="{{ route('property.details', $details['p_id']) }}" target="_blank">Pay Now</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
